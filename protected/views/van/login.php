                    ...
                    <ul class="nav top-2">
                        ...
                        <li class="active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="page_login.html">Login</a></li>
	...
	<div class="row-fluid">
        <form class="log-page"  />
            ...
            <div class="input-prepend">
                ...
                <input id="L_username" class="input-xlarge" type="text" placeholder="Your Username"  value="asdsad"/>
            </div>
            <div class="input-prepend">
                <span class="add-on"><i class="icon-lock"></i></span>
                <input id="L_password" class="input-xlarge" type="password" placeholder="Your Password" value="dsadsadsa" />
            </div>
            <div class="controls form-inline">
                <label class="checkbox"><input type="checkbox" /> Stay Signed in</label>
                <button class="btn-u pull-right" onclick="login();">Login</button>
            </div>
            <hr />
